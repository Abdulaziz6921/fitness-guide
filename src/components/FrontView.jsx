...
function FrontView({ handleMuscleClick }) {
  return (
    <svg
      ...
      className="w-[280px] h-[400px] md:w-[350px] md:h-[500px] lg:w-[500px] lg:h-[600px] object-contain transition-all duration-500"
    >
      <defs>
        <radialGradient
          id="jointradial"
      ...
      <g
        id="calves"
        className="bodymap text-red-700 hover:text-red-400 cursor-pointer transition-all duration-300"
      ...
      <g
        id="hands"
        className="bodymap text-red-700 hover:text-red-400 cursor-pointer transition-all duration-300"
        onClick={() => handleMuscleClick("hands")}
      >
        <path
      ...
      <g id="body" className="body-map__model pointer-events-none">
        <line
          x1="330.4"
          y1="504.57"
          x2="330.4"
